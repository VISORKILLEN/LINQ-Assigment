...
namespace LINQ_Assigment.Models
{
    internal class OnlineStoreContext : DbContext
    {
        ...
        {
            // Seed Categories with correct Id values
            ...
            // Seed Suppliers with correct Id values
            ...
            // Seed Products with correct CategoryId and SupplierId references
            ...
            // Seed Customers with correct Id values
            ...
            // Seed Orders with correct CustomerId references
            ...
            // Seed OrderDetails with correct OrderId and ProductId references
